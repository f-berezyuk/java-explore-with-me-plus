...
import ru.practicum.EWM.stat.server.error.ValidationException;
import ru.practicum.EWM.stat.server.mapper.EndpointHitMapper;
import ru.practicum.EWM.stat.server.repository.EndpointHitEntityRepository;
